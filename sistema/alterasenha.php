      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Senhas</li>
          </ol>
          ...
          <div class="container">
              <div class="card card-register mx-auto mt-5">
                ...
                <div class="card-body">
                  <form method="post" action="includes/altsenhabd.php" id="contact_form" name="contact_form">
                    ...
                    <div class="form-group">
                    	<input name="form_botcheck" class="form-control" type="hidden" value="<?php echo $id;?>" />
                        <button type="submit" class="btn btn-theme-colored btn-block" data-loading-text="Enviando...">Alterar</button>
                    </div>
                  </form>
                </div>
              </div>
