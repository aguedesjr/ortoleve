        ...
        <div class="container-fluid">
          ...
          <div class="container">
              <div class="card card-register mx-auto mt-5">
                ...
                <div class="card-body">
                  <form method="post" action="includes/delprocbd.php" id="contact_form" name="contact_form">
                  	
                    <div class="form-group">
                      <div class="form-row">
                        <div class="col-md-6">
                          <div class="form-label-group">
                            <input type="text" id="nome" name="nome" class="form-control" placeholder="Nome do Procedimento" value="<?php echo utf8_encode($result[2]);?>" readonly="readonly" />
                            <label for="nome">Nome do Procedimento</label>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-label-group">
                            <input type="text" id="codigo" name="codigo" class="form-control" placeholder="Código" value="<?php echo $codigo;?>" readonly="readonly">
                    ...
                    <div class="form-group">
                      <div class="form-row">
                        <div class="col-md-6">
                          <div class="form-label-group">
                          	<input type="text" id="categoria" name="categoria" class="form-control" placeholder="Código" value="<?php echo utf8_encode($result1[0]);?>" readonly="readonly">
                        ...
                        <div class="col-md-6">
                          <div class="form-label-group">
                            <input type="text" id="desconto" name="desconto" class="form-control" placeholder="Desconto" value="<?php echo utf8_encode($result[5]);?>" readonly="readonly">
                    ...
                    <div class="form-group">
                    	<div class="form-row">
                        	<div class="col-md-6">
                              <div class="form-label-group">
                                <input type="text" id="valortab" name="valortab" class="form-control" data-thousands="." data-decimal="," placeholder="Valor Tabelado" value="<?php echo utf8_encode($result[3]);?>" readonly="readonly">
                            ...
                            <div class="col-md-6">
                              <div class="form-label-group">
                                <input type="text" id="valordesc" name="valordesc" class="form-control" data-thousands="." data-decimal="," placeholder="Valor com Desconto" value="<?php echo utf8_encode($result[4]);?>" readonly="readonly">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-theme-colored btn-block" style="bgcolor: '#ff7351'" data-loading-text="Enviando...">Excluir</button>
                    </div>
                  </form>
                </div>
              </div>
