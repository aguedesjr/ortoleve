          ...
          <div class="container pt-0 pb-0">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                ...
                <h2 class="mt-0">Oops! Página não encontrada</h2>
                <p>A página que você procura não pode ser encontrada.</p>
                <!--  <a class="btn btn-theme-colored btn-sm href="index.php">Return Home</a> -->
                <a href="index.php" class="btn btn-theme-colored"><i class="fa fa-home"></i> Home</a>
              </div>
            </div>
          </div>
        </div>
