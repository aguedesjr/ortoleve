        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title text-white">Fotos</h2>
      ...
      <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h2 class="text-uppercase mt-0 line-height-1">Nossas Instalações</h2>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="gallery-isotope default-animation-effect grid-4 gutter-small clearfix" data-lightbox="gallery">
              ...
              <!-- Portfolio Item Start -->
              <div class="gallery-item">
                <a href="images/consultorio4.jpg" data-lightbox="gallery-item" title=""><img src="images/consultorio4.jpg" alt=""></a>
              </div>
              <!-- Portfolio Item End -->
              
              <!-- Portfolio Item Start -->
              <div class="gallery-item">
                <a href="images/consultorio5.jpg" data-lightbox="gallery-item" title=""><img src="images/consultorio5.jpg" alt=""></a>
              </div>
              <!-- Portfolio Item End -->
              
              <!-- Portfolio Item Start -->
              <div class="gallery-item">
                <a href="images/consultorio6.jpg" data-lightbox="gallery-item" title=""><img src="images/consultorio6.jpg" alt=""></a>
              </div>
              <!-- Portfolio Item End -->
